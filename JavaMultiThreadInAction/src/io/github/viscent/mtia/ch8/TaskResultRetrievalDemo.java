...
public class TaskResultRetrievalDemo {
  ...
  /*final ThreadPoolExecutor executor = new ThreadPoolExecutor(0, N_CPU * 2, 10,
      TimeUnit.SECONDS,
  ...
  public static void main(String[] args) {
    ...
    Future<String> future2 = demo.recognizeImage("/tmp/images/0001.png");
    // 执行其他操作
    doSomething();
    try {
